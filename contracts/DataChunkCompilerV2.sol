...
contract DataChunkCompilerV2 is IDataChunkCompilerV2 {
    ...
    string public constant BEGIN_SCRIPT_DATA_DEFER = "%253Cscript%2520defer%2520src%253D%2527"; // <script defer src='
        ...
        return
            string(
                abi.encodePacked(
                    ...
                    "%253D%2522",
                    value,
                    "%2522%253B" // space, equal, quote, quote, semicolon
                )
            );
    }
    ...
    function compile4(
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data()));
    }
    ...
    function compile5(
        ...
        return string(abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data()));
    }
    ...
    function compile6(
        ...
        return
            string(
                abi.encodePacked(data1.data(), data2.data(), data3.data(), data4.data(), data5.data(), data6.data())
            );
    }
